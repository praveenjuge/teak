...
import type { CardModalCard } from "../../../src/components/card-modal/types";
...
mock.module("../../../src/components/Loading", () => ({
  Loading: () => React.createElement("div", { className: "loading-spinner" }),
}));

// Mock card modal components
mock.module("../../../src/components/card-modal/CardModalPreview", () => ({
