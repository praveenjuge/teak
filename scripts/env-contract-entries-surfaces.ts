...
export const SURFACE_ENTRIES: EnvVarSpec[] = [
  ...
  spec("NEXT_PUBLIC_FILES_BASE", {
    ...
    providers: ["dotenv-local", "vercel"],
    required: false,
    note: "Build-time mirror of the backend FILES_BASE for the web CSP. Optional; static Teak origins always apply.",
  }),
  spec("NEXT_PUBLIC_FILES_LEGACY_BASE", {
    owners: ["@teak/web"],
    targets: ["web"],
    profiles: ["local", "preview", "production"],
    secret: false,
    ...
    providers: ["dotenv-local", "vercel"],
    required: false,
    note: "Build-time mirror of the backend FILES_LEGACY_BASE for the web CSP. Optional; static Teak origins always apply.",
  }),
