...
- Text cards now show Markdown formatting while you write, with quick selection controls for emphasis, links, and code, plus clearer tables, comments, and code blocks.
