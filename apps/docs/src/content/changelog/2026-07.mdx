...
- Writing Markdown notes is faster with clickable tasks, automatic list continuation and indentation, strikethrough controls, and quick actions to open, copy, or edit links.
