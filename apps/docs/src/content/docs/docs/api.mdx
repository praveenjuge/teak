...
- Local development: your Convex site URL plus `/v1`
- OpenAPI: `https://api.teakvault.com/openapi.json`

Production requests to `api.teakvault.com` may receive a permanent `308`
redirect to Teak's Convex site URL. API clients should follow redirects while
preserving the request method and headers.
...
- Local development: your Convex site URL plus `/mcp`
