...
- **Register with Email** — create a new account with email and password

Both email options open a native iOS form sheet. Tap the checkmark to confirm. For new accounts, use a password of at least 8 characters — Teak will send a verification email you must open before signing in.
