...
- **Continue with Apple** — one-tap authentication using your Apple ID (iOS only)
- **Continue with Google** — OAuth sign-in via browser redirect
- **Login with Email** — opens a native iOS form sheet; enter your email and password
- **Register with Email** — opens a native iOS form sheet to create a new account

### Email Sign In

Tap **Login with Email** on the welcome screen. A native iOS form sheet slides up with two fields:

- **Email** — your registered email address
- **Password** — your account password

Tap the checkmark in the top-right corner to sign in. The checkmark only activates once both fields are filled.

### Email Sign Up

Tap **Register with Email** on the welcome screen. A native iOS form sheet slides up with the same two fields:

- **Email** — the address you want to register with
- **Password** — minimum 8 characters

Tap the checkmark to submit. After successful registration, Teak sends a verification email to the address you entered. Open the link in that email to activate your account before signing in.
