...
| **Settings…** | Opens the Settings page (account info, API keys, billing) |
| **Log Out** | Signs you out and returns to the login screen |

## Settings

Open **Teak menu → Settings…**, or click the **gear icon** (⚙) in the top-right corner of the cards view, to open the Settings page. Use the **← Back** link at the top of the page to return to your cards.
