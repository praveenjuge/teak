...
npx convex env set CONVEX_SITE_URL https://name-123.convex.site
```
...
4. Keep your Clerk project alive for the Expo app + extension until their migrations land.
...
# Secrets live in Convex via `npx convex env set BETTER_AUTH_SECRET ...`
```
