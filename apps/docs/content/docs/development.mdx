...
- REST API: `http://api.teak.localhost:1355/v1`
- MCP endpoint: `http://api.teak.localhost:1355/mcp`
...
- `TEAK_DEV_APP_URL` defaults to `http://app.teak.localhost:1355`
- `TEAK_DEV_API_URL` defaults to `http://api.teak.localhost:1355`
- `TEAK_DEV_DOCS_URL` defaults to `http://docs.teak.localhost:1355`
