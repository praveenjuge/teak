...
- Browser sign-in connects Raycast without copying a key. Use **Sign Out** from any command's action panel to revoke this installation, or **Settings → Security → Connections** to disconnect every installation.
