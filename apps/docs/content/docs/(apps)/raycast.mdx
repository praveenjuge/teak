...
2. Run any Teak command and choose **Sign in with Browser**. Your browser opens to authorize Teak, then returns you to Raycast — no key to copy.
...
- If you use an API key instead, it only connects Raycast to your Teak account. Revoke, disable, or regenerate it anytime from Teak Settings.
