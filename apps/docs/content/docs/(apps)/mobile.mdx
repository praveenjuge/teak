...
The share extension shows live status while saving, including which items failed. If it asks you to sign in, open Teak, sign in, then retry.

Supported share sources include links, text, images, and files, with the same format support as the web app (see [Features](/docs/features)), up to 100 MB.
