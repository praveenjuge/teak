...
ADMIN_USERID=your-user-id                    # Admin access
...
| Admin Dashboard   | `ADMIN_USERID`                                                           | Pipeline insights, monitoring        |
...
E2E_BETTER_AUTH_USER_EMAIL=test@example.com
E2E_BETTER_AUTH_USER_PASSWORD=password123
E2E_BETTER_AUTH_ADMIN_EMAIL=admin@example.com
E2E_BETTER_AUTH_ADMIN_PASSWORD=password123
```
