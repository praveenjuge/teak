...
For agents running inside the signed-in Teak web app, [WebMCP](/docs/webmcp)
offers read-only card tools with no extra authentication.
...
- Generate and manage API keys in Teak Settings. Each account can keep up to 10 active keys.
  </Tab>
</Tabs>
