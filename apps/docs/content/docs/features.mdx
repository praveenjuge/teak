...
One-click saving from any website. Auto-saves the current page when you open the popup, right-click any page to save with full metadata, highlight text to save as a text card, and inline save buttons on Instagram, Pinterest, X, Hacker News, Sidebar, Web Designer News, and HeyDesigner. See the [Browser Extension guide](/docs/extension) for setup and full details.
