...
- File uploads now support source code, Markdown and MDX, design tokens, ZIP, Office documents, SVG, HEIC, animated GIF, Figma files, and more across every app, with a 100 MB limit.
