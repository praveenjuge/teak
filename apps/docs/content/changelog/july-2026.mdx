...
- Docs, apps, pricing, and changelog now share the same top navigation, search, and theme controls.
- The changelog has an RSS feed at teakvault.com/changelog/rss.xml, also linked from the site footer.
