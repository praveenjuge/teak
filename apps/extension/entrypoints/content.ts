...
const ICONS: Record<Exclude<ButtonState, "idle">, string> = {
  saving: `<svg class="teak-spin" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="8" stroke-width="2" fill="none" /></svg>`,
...
const injectStyleTag = () => {
  ...
  style.textContent = `
    ...
    .teak-save-button[data-state="idle"]:hover .teak-brand-icon svg {
      filter: none;
    }
    ...
    .teak-save-button[data-state="error"] {
      background: #fef2f2;
      border-color: #ef4444;
      color: #991b1b;
    }

    .teak-save-button:focus-visible {
