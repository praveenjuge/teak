...
export function HomeClient({ preloadedCards }: HomeClientProps) {
  ...
  const remoteCards = useQuery(api.cards.searchCards, {
  ...
  const cards =
    remoteCards ?? (isDefaultState ? preloadedCardsResult : undefined);
